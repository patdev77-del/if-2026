...
// TODO Day 1: replace with your own name and bio
const name = 'Your Name'
const bio = 'A short sentence about who you are and what you do.'

// TODO Day 1: replace with your own skills
const skills = ['HTML', 'CSS', 'JavaScript']

const newSkill = ref('')

function addSkill() {
  // TODO Day 1: push newSkill.value into skills, then clear the input
...
<template>
  <section class="hero">
    ...
    <!-- TODO Day 1: wire up v-model and the addSkill button -->
    <div class="add-skill">
      <input v-model="newSkill" placeholder="Add a skill…" @keyup.enter="addSkill" />
      <button @click="addSkill">Add</button>
    </div>
    <!-- TODO Day 1: just for debugging: Remove when implementation is ready -->
